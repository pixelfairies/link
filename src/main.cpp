...
uint256 hashGenesisBlock("0x825bacf90fd69184af6dffa9c4f4ed316dad280a26e59593efa54dccc10c1b6f");
...
const string strMessageMagic = "Pixels Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 20) // no block reward within the first 20 blocks
        nSubsidy = 0;
    if(nHeight > 100000998) // no block reward after trillion coins
        nSubsidy = 0;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60; // Pixels: 1 hour difficulty adjustment
static const int64 nTargetSpacing = 30; // Pixels: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Pixels miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Pixels", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	/* Genesis block:
	 ...
	 vMerkleTree: 5a2e19825b
         ...
         Genesis block */
        const char* pszTimestamp = "US judge dismisses lawsuit over drone strikes";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1396651000;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085899886;
        ...
        assert(block.hashMerkleRoot == uint256("0x1160842f1d40fc4b02f8c3ff5a753fdf2266ca2841cf7967b4c28733d5b22c0b"));
